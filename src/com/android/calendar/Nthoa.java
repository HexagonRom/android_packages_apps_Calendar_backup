...
public class Nthoa {
	...
	public static void main(String[] args) {
    	double TZ = 7.0;
    	int[] result = convertSolar2Lunar(13,5,2019,7);
    	System.out.println(result[0] + "/" + result[1] + "/" + result[2]);
    }*/
	
	public static String getLunar(int dd,int mm,int yy,int timeZone,Context context) {
		Log.i("NTHOA",dd + "/" + mm + "/" +yy);
		int[] result = convertSolar2Lunar(dd,mm,yy,timeZone);
		//String result = "";
		if (result[0] == 1) {
			String month = "";
			switch (result[1]) {
				case 1:
					month = context.getString(R.string.nthoa_month_1);
					break;
				case 2:
					month = context.getString(R.string.nthoa_month_2);
					break;
				case 3:
					month = context.getString(R.string.nthoa_month_3);
					break;
				case 4:
					month = context.getString(R.string.nthoa_month_4);
					break;
				case 5:
					month = context.getString(R.string.nthoa_month_5);
					break;
				case 6:
					month = context.getString(R.string.nthoa_month_6);
					break;
				case 7:
					month = context.getString(R.string.nthoa_month_7);
					break;
				case 8:
					month = context.getString(R.string.nthoa_month_8);
					break;
				case 9:
					month = context.getString(R.string.nthoa_month_9);
					break;
				case 10:
					month = context.getString(R.string.nthoa_month_10);
					break;
				case 11:
					month = context.getString(R.string.nthoa_month_11);
					break;
				case 12:
					month = context.getString(R.string.nthoa_month_12);
					break;
