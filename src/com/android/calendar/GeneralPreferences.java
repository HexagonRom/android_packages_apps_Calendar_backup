...
public class GeneralPreferences extends PreferenceFragment implements
	...
	public static final String KEY_SHOW_LUNAR = "nthoa_show_lunar_key";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mUseHomeTZ) {
			...
			Utils.setSharedPreference(activity,"nthoa_show_lunar",isShow);
			mShowLunar.setChecked(isShow);
			//Settings.System.putInt(getActivity().getContentResolver(),"nthoa_show_lunar", isShow ? 1 : 0);
			return true;
		} else {
            return true;
        }
    ...
    private void migrateOldPreferences(SharedPreferences prefs) {
		...
		//Nthoa
		mShowLunar.setChecked(Utils.getIsShowLunar(getActivity()));
